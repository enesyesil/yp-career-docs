...
> 🧭 *Her şeyi çözmenize gerek yok — sadece başlamanız gerekiyor.*
...
|------|-----------|-------------|
| 1️⃣ | [Başlangıç Rehberi](getting-started.md) | İlk hafta rehberiniz: başlangıç, formlar ve kontrol listesi |
| 2️⃣ | [Çalışma Yol Haritaları](study-roadmaps.md) | İlgi alanına göre öğrenme yollarını ve beceri planlarını keşfedin |
| 3️⃣ | [SSS](faq.md) | Toplantılar, kaynaklar ve takip hakkında hızlı cevaplar bulun |
| 4️⃣ | [Kaynaklar](../resources/index.md) | Şablonlara, etkinliklere ve faydalı bağlantılara erişin |
...
| Seviye | Odak | Temel Sonuçlar |
|--------|--------|----------------|
| **Foundation** | Yönlendirme ve organizasyon | Çalışma alışkanlıkları ve öz farkındalık oluştur |
| **Candidacy** | Hazırlık | Güçlü bir özgeçmiş ve profesyonel varlık oluştur |
| **Strategy** | Uygulama | Mülakatları pratik yap, stajlara hazırlan |
| **Experience** | Yansıma | Başvur, öğren ve sonuçları kaydet |
...
> 💡 *YPCA, eylem üzerine kurulu bir sistemdir — küçük, tutarlı adımlar ölçülebilir ilerlemeye yol açar.*
