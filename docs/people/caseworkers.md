...
|-----------|---------------|
| **Communication** | Maintain clear, respectful, and timely communication. Keep all updates written and accessible. |
| **Consistency** | Follow the same structure for every mentee: diagnosis → plan → review. |
...
| Partner | Interaction |
|----------|--------------|
| **Mentees** | Primary relationship — frequent check-ins and planning |
| **Professionals** | Invite for short advisory sessions when mentees need career validation |
| **Program Leads** | Share summary data, flag mentee needs, suggest improvements |
...
> 💡 *Caseworkers make the system human — they turn structure into genuine progress.*
